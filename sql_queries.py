...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id int, start_time TIMESTAMP, user_id text, level text, 
...
song_id, artist_id, session_id, location, user_agen) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s);
""")
